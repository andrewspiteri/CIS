---
title: "WORK-020-BACKOFFICE Render and approve the visual design pack (backoffice)"
type: agent-task
status: Draft
task_status: Approved
task_id: WORK-020-BACKOFFICE
task_type: core.design.visual
...
depends_on: ["WORK-010-BACKOFFICE"]
...
- Self-contained Sharp/SVG .mjs renderer
- PNG manifest
- Combined wireframe/design approval record
...
- Human approval gate: the Sharp/SVG renderer and PNG manifest must be recorded in `../design.md` against the approved guideline digest.
- Global delivery barrier: when the design enters ReadyForReview, all non-review work stops until explicit approval. Rejection permits only wireframe/design revision.
...
- [ ] Rendered assets cover required states and are nonblank.
- [ ] Human design approval is recorded with approver and date.
