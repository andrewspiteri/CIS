...
| change-impact-studio:standard:security-testing | SEC-TEST-001 | source and tests | deterministic | `cis security reconcile`; Semgrep result adapter tests | Active | Portable SAST is independent of optional GitHub Code Security. |
| change-impact-studio:standard:security-testing | SEC-TEST-002 | complete revision | deterministic | Gitleaks redacted JSON; secret-redaction regression tests | Active | Secret values are never normalized or prompted. |
| change-impact-studio:standard:security-testing | SEC-TEST-003 | manifests and deployment configuration | deterministic | Trivy filesystem/config results | Active | Classification selects applicable suites. |
| change-impact-studio:standard:security-testing | SEC-TEST-004 | releaseable images | deterministic | Trivy image result and immutable image identity manifest | Active | Promotion cannot rebuild after scan. |
| change-impact-studio:standard:security-testing | SEC-TEST-005 | external HTTP surfaces | deterministic | ZAP result and managed-runtime metadata | Active | Unavailable authenticated coverage remains explicit. |
| change-impact-studio:standard:security-testing | SEC-TEST-006 | scanner evidence | deterministic | Missing, malformed, empty, and partial adapter fixtures | Active | Process success alone is not proof. |
| change-impact-studio:standard:security-testing | SEC-TEST-007 | accepted findings | deterministic | `cis security exceptions validate --strict` | Active | Exact fingerprint and human governance required. |
| change-impact-studio:standard:security-testing | SEC-TEST-008 | AI security triage | deterministic | local-only generation request and summary metadata tests | Active | Model output cannot alter verdicts. |
| change-impact-studio:standard:security-testing | SEC-TEST-009 | logs, results, manifests | deterministic | artifact hash and correlation tests | Active | Evidence binds revision, run, attempt, suite, and component. |
| change-impact-studio:standard:security-testing | SEC-TEST-010 | release verification | deterministic | security status, revision freshness, and release gates | Active | Critical/high, stale, missing, and invalid evidence block. |
...
| change-impact-studio:standard:secure-feature-implementation | SEC-FEAT-001 | security, backend, frontend | manual-review | Inspect contract and permission references. | Active | PARR-derived starter; strengthen with deterministic enforcement where practical. |
| change-impact-studio:standard:secure-feature-implementation | SEC-FEAT-002 | security, backend, frontend | manual-review | Test denied access at the trusted enforcement boundary. | Active | PARR-derived starter; strengthen with deterministic enforcement where practical. |
| change-impact-studio:standard:secure-feature-implementation | SEC-FEAT-003 | security, backend, frontend | manual-review | Test cross-scope and object-level access attempts. | Active | PARR-derived starter; strengthen with deterministic enforcement where practical. |
| change-impact-studio:standard:secure-feature-implementation | SEC-FEAT-004 | security, backend, frontend | manual-review | Run secret scanning and inspect logging/error paths. | Active | PARR-derived starter; strengthen with deterministic enforcement where practical. |
| change-impact-studio:standard:secure-feature-implementation | SEC-FEAT-005 | security, backend, frontend | manual-review | Test invalid, oversized, and malicious input cases. | Active | PARR-derived starter; strengthen with deterministic enforcement where practical. |
| change-impact-studio:standard:secure-feature-implementation | SEC-FEAT-006 | security, backend, frontend | manual-review | Review security tasks, tests, and independent assurance. | Active | PARR-derived starter; strengthen with deterministic enforcement where practical. |
