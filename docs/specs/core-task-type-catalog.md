...
| 160 | `core.verification` | Verification | Always | Every applicable implementation/operations type; Design when UI-bearing | `verification.md` acceptance and negative-criteria evidence | Every requirement and prohibited behavior has reproducible passing evidence or approved residual risk. |
