...
public sealed class CoreTaskTypeProvider : ICisTaskTypeProvider
{
    ...
    [
        ...
        Define("core.design.wireframe", "wireframe", "Define textual screens, states, actions, and paths", 10, "conditional",
            ...
            "Create the approved textual behavioral and navigation contract in wireframes.md.",
            "Every affected screen, state, action, condition, side effect, and destination path is explicit and behaviorally approved.",
            "Validate screen/action identity, path resolution, state and requirement coverage, and human approval.", "human-wireframe-approval"),
        Define("core.design.visual", "design", "Render and approve the visual design pack", 20, "conditional",
            ...
            "The exact guideline-conformant renderer and PNG manifest are validated and explicitly approved before any downstream work.",
            "Validate guideline provenance, shell/component templates, Sharp/SVG execution, PNG coverage, hashes, and approval.", "global-design-approval"),
        ...
        Define("core.api.contract", "contract", "Implement API and consumed contracts", 80, "conditional",
            [" api", "endpoint", "dto", "openapi", "contract", "request", "response", "etag"], [], "medium",
            "Implement governed API/message contracts with explicit exposure, scope, authorization, validation, compatibility, errors, rate limits, idempotency, concurrency, and telemetry semantics.",
            ...
            "Run handler, authorization, abuse, validator, compatibility, integration, schema, OpenAPI-diff, and contract-drift checks."),
        ...
        Define("core.verification", "verification", "Complete targeted and regression verification", 160, "always", [], [], "medium",
            ...
            "All acceptance and negative criteria have reproducible passing evidence or approved residual risk.",
            "Run focused and affected suites, contract/migration checks, browser journeys, and coverage gates."),
    ...
    private static CisTaskTypeDefinition Define(
        ...
        => new(key, "1.0", category, title, order, policy, triggers, dependencies,
